...
dev_eh=np.loadtxt('OUT\DEV_H2.csv', delimiter=',', dtype=np.float64)
dfds=np.loadtxt('OUT\dfds.csv', delimiter=',', dtype=np.float64)
...
ang=360;
dev_h=dev_h*0.5;
plt.arrow(0,0,dev_h[0],dev_h[1], width=0.015, color='red', zorder=5)
dev_eh=dev_eh*0.3;
plt.arrow(stress[0,0],stress[0,1],dev_eh[0],dev_eh[1], width=0.015, color='green', zorder=5)
r2=r*1.1
...
# HAH20h
plt.plot(stress[:,0], stress[:,1], linewidth=2.5, label='HAH'+'$_{h}$')
# HAH20e
plt.plot(stress2[:,0], stress2[:,1], linewidth=2.5, linestyle='dashed', label='HAH'+'$_{\epsilon}$')
#plt.plot([stress[0,0],stress[0,0]*(-dfds[1])], [stress[0,1],stress[0,1]*dfds[0]])
ang=360;
dfds=0.8*dfds;
p1=[stress[ang-1,0],stress[ang-1,1]]
p2=[stress[ang-1,0]-dfds[1],stress[ang-1,1]+dfds[0]]
color='green'
plt.plot([p1[0],p2[0]], [p1[1],p2[1]], c=color)
plt.plot([p1[0],p2[0]+2*dfds[1]], [p1[1],-p2[1]], c=color)
ang=180;
p1=[stress[ang-1,0],stress[ang-1,1]]
p2=[stress[ang-1,0]-dfds[1],stress[ang-1,1]+dfds[0]]
plt.plot([p1[0],p2[0]], [p1[1],p2[1]], c=color)
...
p2=[stress[ang-1,0]-dfds[1],stress[ang-1,1]+dfds[0]]
color='gray'
plt.plot([p1[0],p2[0]], [p1[1],p2[1]], c=color, linewidth=2.5)
plt.plot([p1[0],p2[0]+2*dfds[1]], [p1[1],-p2[1]], c=color, linewidth=2.5)
ang=180;
p1=[stress[ang-1,0],stress[ang-1,1]]
p2=[stress[ang-1,0]-dfds[1],stress[ang-1,1]+dfds[0]]
plt.plot([p1[0],p2[0]], [p1[1],p2[1]], c=color, linewidth=2.5)
...
print(p1)
print(p2)
#plt.plot([stress2[:,0]], stress2[:,1], linewidth=2.5)
