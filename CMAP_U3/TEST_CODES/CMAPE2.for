...
5     FORMAT(1X,I8,',',I8,',',F8.2',',F8.2,',',F8.2)
C-----------------------------------------------------------------------
...
C     # OBTAIN CONVERGENCE BEHAVIOR
          IF(VAL.EQ.0.D0.AND.ANG2.EQ.0.D0) THEN ! RD TENSION
              BC=2*BC
          END IF
          CALL INIT_STRESS(BC,HARD_VAR,STRESS,STRAN,EQPLAS,DDSDDE)
          CALL EQV_SIG(HARD_VAR, STRESS, SIG_BAR)
          ...
          END IF
          CALL EQV_SIG(HARD_VAR, STRESS, SIG_BAR)
          WRITE(120, *) SIG_BAR, FLOW_SIG, SIG_BAR-FLOW_SIG
          HARD_VAR0=HARD_VAR
          DDSDDE0=DDSDDE
          EQPLAS0=EQPLAS
          DFDS=0.D0
