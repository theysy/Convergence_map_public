...
plt.arrow(0,0,pp_axis[1,0],pp_axis[1,1], width=0.015, color='black')
...
plt.arrow(0,0,pp_axis[2,0],pp_axis[2,1], width=0.015, color='black')
plt.annotate("$s_{zz}$", xy=(pp_axis[2,0],pp_axis[2,1]), size=30, xytext=(pp_axis[2,0]+0.05,pp_axis[2,1]-0.05))
plt.arrow(0,0,dev_h[0],dev_h[1], width=0.01, color='red')
plt.arrow(0,0,dev_eh[0],dev_eh[1], width=0.01, color='green')
...
# HAH20h
plt.plot(stress[:,0], stress[:,1], linewidth=2.5, label='HAH'+'$_{20h}$')
# HAH20e
